    ...
    (Neela = {
        ...
        preloader: function () {
            var e = setInterval(function () {
                    /loaded|complete/.test(document.readyState) && (clearInterval(e), u("#preloader").fadeOut(1000))
            }, 10)
        },
        navigation: function () {
                ...
                for (n = u(this).attr("id"), (s = new google.maps.Map(document.getElementById(n), a)).mapTypes.set("map_style", e), s.setMapTypeId("map_style"), o = function (e) {
                    var t = e.latitude, a = e.longitude, n = e.icon, e = e.infoWindow,
                        ...
                        i = new RichMarker({
                            ...
                            map: s,
                            anchor: 8,
                            anchorPoint: new google.maps.Point(0, -80),
                            shadow: "none",
